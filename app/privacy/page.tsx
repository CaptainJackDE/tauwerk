  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Wir verwenden verschiedene Analyse-Tools, um die Nutzung unserer Website zu verbessern. 
          Diese Tools helfen uns, die Nutzung unserer Website zu verstehen und zu optimieren.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Sie haben jederzeit das Recht auf Auskunft über die zu Ihrer Person gespeicherten Daten, deren Herkunft und 
          Empfänger und den Zweck der Datenverarbeitung sowie ein Recht auf Berichtigung oder Löschung dieser Daten.
        </p>
      </section>
