      ...
      <div className="space-y-24">
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              Wir streben danach, eine lebendige Community zu schaffen, in der
              Menschen ihre Leidenschaft für Technologie und Innovation teilen
              können.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-foreground/70">
                Unser Ziel ist es, einen Raum zu schaffen, in dem Menschen ihre
                Ideen teilen, voneinander lernen und gemeinsam wachsen können.
                Wir glauben an die Kraft der Gemeinschaft und daran, dass wir
                gemeinsam mehr erreichen können als jeder für sich allein.
              </p>
              <p className="text-foreground/70">
                Durch regelmäßige Events, Workshops und Networking-Möglichkeiten
                schaffen wir eine Plattform für den Austausch von Wissen und
                Erfahrungen. Wir fördern Innovation und Kreativität, indem wir
                Menschen zusammenbringen, die ihre Leidenschaft für Technologie
                teilen.
              </p>
            </div>
            <div className="space-y-6">
              ...
              <p className="text-foreground/70">
                Wir organisieren regelmäßige Events und Workshops, die sowohl
                für Anfänger als auch für Experten interessant sind. Unser Fokus
                liegt dabei auf praktischem Lernen und dem direkten Austausch
                zwischen den Teilnehmern.
              </p>
              <p className="text-foreground/70">
                Wir arbeiten eng mit lokalen Unternehmen und
                Bildungseinrichtungen zusammen, um ein breites Spektrum an
                Themen abzudecken und unseren Mitgliedern Zugang zu
                verschiedenen Perspektiven und Ressourcen zu ermöglichen.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              Diese Grundwerte bilden das Fundament unserer Community und leiten
              unser Handeln.
            </p>
          </div>
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              Die Menschen hinter Tauwerk, die unsere Vision leben und die
              Community gestalten.
            </p>
          </div>
